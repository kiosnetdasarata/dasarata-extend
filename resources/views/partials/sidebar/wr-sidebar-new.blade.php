        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('warehouse.warehouse') }}"
                    class="w-full flex hov items-center whitespace-nowrap gap-3 px-5 py-3 hover:text-white hover:bg-dasarataHover rounded-lg dark:text-white [&.active]:bg-dasarataHover [&.active]:text-white {{ Request::is('warehouse') ? 'active' : '' }}">
            ...
            <li
                class="flex items-center border-t border-hidden line w-full rounded-lg [&.active]:bg-emerald-200 dark:text-white">
            ...
            <li>
                <a href="{{ route('warehouse.modem-type.index') }}"
                    class="flex items-center gap-3 hov whitespace-nowrap w-full px-5 py-3 hover:text-white hover:bg-dasarataHover dark:text-white transition duration-75 rounded-lg [&.active]:bg-dasarataHover [&.active]:text-white {{ Request::is('warehouse/modem-type*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 img dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 20 16">
                        <path stroke="currentColor" stroke-linejoin="round" stroke-width="2"
                            d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Z" />
                    </svg>
                    <span class="text">Modem Types</span>
                </a>
            </li>
            <li>
                <a href="{{ route('warehouse.modem-list.index') }}"
                    class="flex items-center gap-3 hov whitespace-nowrap w-full px-5 py-3 hover:text-white hover:bg-dasarataHover dark:text-white transition duration-75 rounded-lg [&.active]:bg-dasarataHover [&.active]:text-white {{ Request::is('warehouse/modem-list*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 img dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="text">Modem List</span>
                </a>
            </li>
            <li>
                <a href="{{ route('warehouse.psb-modem') }}"
                    class="flex items-center gap-3 hov whitespace-nowrap w-full px-5 py-3 hover:text-white hover:bg-dasarataHover dark:text-white transition duration-75 rounded-lg [&.active]:bg-dasarataHover [&.active]:text-white {{ Request::is('warehouse/psb-modem*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 img dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 18 20">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 4H1m3 4H1m3 4H1m3 4H1m6.071.286a3.429 3.429 0 1 1 6.858 0M4 1h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Zm9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
                    </svg>
                    <span class="text">PSB Modems</span>
                </a>
            </li>
        </ul>
    </div>
