...
<div class="p-4 border-2 border-gray-200 border-solid rounded-lg col-lg-8 dark:border-slate-500">
    <form class="mb-6" action="{{ url('employees') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="nickname" name="nickname" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:bg-gray-700  @error('nickname') is-invalid
        ...
        <div class="mb-6">
            ...
            <input type="text" id="email" name="email" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:bg-gray-700  @error('email') is-invalid
            @enderror" value="{{ old('email') }}" placeholder="Email" autocomplete="off">
            @error('email')
            <div class="text-gray-900 invalid-feedback dark:text-white">
                {{ $message }}
            </div>
