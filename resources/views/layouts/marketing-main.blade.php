...
<body class="bg-slate-100 dark:bg-gray-700">
    ...
    {{-- Sidebar --}}
    @include('partials.sidebar.mrkt-sidebar-new')

    <div class="flex content trans sm:ml-60 ml-32 mx-auto" id="content">
        <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="#"
                            class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-200 dark:hover:text-white">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-200 dark:hover:text-white">Settings</a>
                        </div>
                    </li>
