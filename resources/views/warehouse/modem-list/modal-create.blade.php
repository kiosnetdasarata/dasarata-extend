                    ...
                    @csrf
                        <div class="mb-6">
                            <label for="type_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Versi Modem</label>
                                ...
                                @enderror">
                                    <option value="" selected>--Pilih Versi Modem--</option>
                        ...
                        <div class="relative max-w mb-6">
                            ...
                            <input name="modem_masuk" datepicker value="{{ old('modem_masuk') }}" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 " autocomplete="off" placeholder="Pilih Tanggal">
                        </div>
                        <div class="mb-6">
                            <label for="tujuan_out" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tujuan Out</label>
                                ...
                                @enderror">
                                    <option value="" selected>--Tujuan Out--</option>
