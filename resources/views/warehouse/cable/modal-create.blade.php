    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
              <h3 class="mb-4 text-2xl font-bold leading-none tracking-tight text-black md:text-2xl dark:text-slate-200">Input Kabel</h3>
              <div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
                <form name="createCable" action="{{ url('cable') }}" method="POST">
                    @csrf
                        {{-- <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="merk_kabel" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Merk kabel</label>
                            <input type="text" id="merk_kabel" name="merk_kabel" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('merk_kabel') is-invalid
                            @enderror" value="{{ old('merk_kabel') }}" placeholder="Merk Kabel">
                        </div>
                        <div class="mb-6">
                            <label for="jenis_kabel" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Kabel</label>
                            <input type="text" id="jenis_kabel" name="jenis_kabel" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('jenis_kabel') is-invalid
                            @enderror" value="{{ old('jenis_kabel') }}" placeholder="Jenis Kabel" required>
                        </div>
                        <div class="mb-6">
                            <label for="kuantitas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kuantitas</label>
                            <input type="text" id="kuantitas" name="kuantitas" class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('kuantitas') is-invalid
                            @enderror" value="{{ old('kuantitas') }}" placeholder="Kuantitas" required>
                        </div>
                        <div class="mb-6">
                            <label for="status_kabel" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status</label>
                                <select id="status_kabel" name="status_kabel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        {{-- <div class="relative max-w mb-6">
                            ...
                            <input name="created_at" datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500  " placeholder="Pilih Tanggal">
                        </div> --}}
