        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
                    <form name="createCable" action="{{ route('warehouse.cable.store') }}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="merk_kabel"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Merk kabel</label>
                            ...
                            @enderror"
                                value="{{ old('merk_kabel') }}" placeholder="Merk Kabel" required>
                            @error('merk_kabel')
                        ...
                        <div class="mb-6">
                            <label for="jenis_kabel"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Kabel</label>
                            ...
                            @enderror"
                                value="{{ old('jenis_kabel') }}" placeholder="Jenis Kabel" required>
                                @error('jenis_kabel')
                                <div class="invalid-feedback text-red-600">
                                    <small>{{ $message }}</small>
                                </div>
                        ...
                        <div class="mb-6">
                            ...
                            @enderror"
                                value="{{ old('quantity') }}" placeholder="Kuantitas" required>
                                @error('quantity')
                                <div class="invalid-feedback text-red-600">
                                    <small>{{ $message }}</small>
                                </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="status_kabel" name="status_kabel"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('quantity') is-invalid
                                @enderror">
