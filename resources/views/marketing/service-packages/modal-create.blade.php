        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
                    <form name="createPackages" action="{{ url('service-packages') }}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="nama_layanan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Paket Layanan</label>
