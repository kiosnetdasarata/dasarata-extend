        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
                    <form name="createPromoActive" action="{{ url('promo-active') }}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="promo_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipe Promo</label>
                                <select id="promo_id" name="promo_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>--Pilih Tipe Promo--</option>
