...
@section('content')
    <div class="px-6 py-6 lg:px-8">
        ...
        <div class="col-lg-8 p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-slate-500">
            <form name="createPromoActive" action="{{ url('marketing/promo-active/'.$promoActive->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-6">
                ...
                <div class="relative max-w mb-6">
                    ...
                    <input name="start_date" datepicker type="text" autocomplete="off"
                        value="{{ old('start_date', $dateStart) }}"
                ...
                <div class="relative max-w mb-6">
                    ...
                    <input name="end_date" datepicker type="text" autocomplete="off"
                        value="{{ old('end_date', $dateEnd) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                        placeholder="Pilih Tanggal">
                </div>
                <button type="submit"
